...
namespace SimpleImageDisplaySample
{
    ...
    internal class ModBusTCPIPWrapper : ModBusWrapper, IDisposable
    {
        ...
        private static short ExtendStartingAddress = (short)(StartingAddress+2);
        ...
        public override void Send(byte[] data)
        {
            ...
            values.AddRange(ValueHelper.Instance.GetBytes(StartingAddress));//TODO:起始地址
            //9~10.起始地址

            values.AddRange(ValueHelper.Instance.GetBytes((short)(6)));//TODO:寄存器数量
            //11~12.寄存器数量
